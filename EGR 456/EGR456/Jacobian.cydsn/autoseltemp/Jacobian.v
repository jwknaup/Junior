// ======================================================================
// Jacobian.v generated from TopDesign.cysch
// 01/18/2018 at 16:36
...
module top ;
    ...
    PWM_v3_30_0 Servos (
        ...
        .ph1(Net_41),
        .ph2(Net_42));
    defparam Servos.Resolution = 16;


	cy_clock_v1_0
		#(.id("0b20d7c4-0a5c-4c2d-a281-ba5851b11f66"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("62ef82b6-bcbd-413e-80f1-b480a5d1f48f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
