...
*
* \funcusage
*  \snippet White_LED_SUT.c usage_White_LED_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet White_LED_SUT.c usage_White_LED_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet White_LED_SUT.c usage_White_LED_Read  
*******************************************************************************/
...
* preferred White_LED_Read() API because the 
* White_LED_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet White_LED_SUT.c usage_White_LED_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: White_LED_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use White_LED_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - White_LED_0_INTR       (First pin in the list)
    *  - White_LED_1_INTR       (Second pin in the list)
    *  - ...
    *  - White_LED_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet White_LED_SUT.c usage_White_LED_SetInterruptMode
    *******************************************************************************/
    void White_LED_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & White_LED_0_INTR) != 0u) 
		{ 
			 White_LED_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet White_LED_SUT.c usage_White_LED_ClearInterrupt
    *******************************************************************************/
