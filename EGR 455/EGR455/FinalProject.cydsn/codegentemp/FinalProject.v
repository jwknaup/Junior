...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("7ee618fb-c5c7-42f1-b7da-1a55b753e713/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=enc, CY_INSTANCE_SHORT_NAME=enc, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=enc, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("740a7d3e-6dad-45d9-90dc-a1a6fd8f7e67"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aff5651d-b3dd-4952-b371-a9380f0890f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    QuadDec_v3_0_3 enc (
        ...
        .clock(Net_218),
        .interrupt(Net_219));
    defparam enc.CounterResolution = 4;
    defparam enc.UsingGlitchFiltering = 1;
    defparam enc.UsingIndexInput = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("1c7878f4-f0ec-4859-81c2-9aa524a3660c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("94d4706b-cff7-4de9-89cb-6f3c94c6831a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c3cba39e-a06d-480f-95ff-f9b9651df8f4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("64c88a3a-e28d-4eb9-9615-bfcef69fb6cf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__mag_net;
	wire [0:0] tmpFB_0__mag_net;
	wire [0:0] tmpIO_0__mag_net;
	wire [0:0] tmpINTERRUPT_0__mag_net;
	electrical [0:0] tmpSIOVREF__mag_net;

	cy_psoc3_pins_v1_10
		#(.id("ac1868fa-1495-4f15-8116-17e14482883b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		mag
		 (.oe(tmpOE__mag_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__mag_net[0:0]}),
		  .io({tmpIO_0__mag_net[0:0]}),
		  .siovref(tmpSIOVREF__mag_net),
		  .interrupt({tmpINTERRUPT_0__mag_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mag_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
