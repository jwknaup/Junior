// ======================================================================
// PeacefulPillowShowcase.v generated from TopDesign.cysch
// 11/27/2017 at 09:27
...
module top ;
	...
	wire [0:0] tmpOE__flexSensorA_net;
	wire [0:0] tmpFB_0__flexSensorA_net;
	wire [0:0] tmpIO_0__flexSensorA_net;
	wire [0:0] tmpINTERRUPT_0__flexSensorA_net;
	electrical [0:0] tmpSIOVREF__flexSensorA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		flexSensorA
		 (.oe(tmpOE__flexSensorA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__flexSensorA_net[0:0]}),
		  .analog({Net_53}),
		  .io({tmpIO_0__flexSensorA_net[0:0]}),
		  .siovref(tmpSIOVREF__flexSensorA_net),
		  .interrupt({tmpINTERRUPT_0__flexSensorA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__flexSensorA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__flexSensorB_net;
	wire [0:0] tmpFB_0__flexSensorB_net;
	wire [0:0] tmpIO_0__flexSensorB_net;
	wire [0:0] tmpINTERRUPT_0__flexSensorB_net;
	electrical [0:0] tmpSIOVREF__flexSensorB_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4ff5b3e2-2307-4da3-835d-93feefba1400"),
		  ...
		  .input_buffer_sel(2'b00))
		flexSensorB
		 (.oe(tmpOE__flexSensorB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__flexSensorB_net[0:0]}),
		  .analog({Net_51}),
		  .io({tmpIO_0__flexSensorB_net[0:0]}),
		  .siovref(tmpSIOVREF__flexSensorB_net),
		  .interrupt({tmpINTERRUPT_0__flexSensorB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__flexSensorB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_4 pwmBuzzer (
        ...
        .ph1(Net_1094),
        .ph2(Net_1095));
    defparam pwmBuzzer.Resolution = 8;
    ...
    UART_v2_50_5 uart2 (
        ...
        .reset(Net_495),
        .rx(Net_496),
        .tx_interrupt(Net_497),
        .rx_interrupt(Net_498),
        .tx_data(Net_499),
        .tx_clk(Net_500),
        .rx_data(Net_501),
        .rx_clk(Net_502));
