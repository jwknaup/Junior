...
module BLE_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("f0d85e21-8b91-42b5-b359-768a8188b708/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
    ...
    UART_v2_50_2 uart (
        ...
        .reset(Net_450),
        .rx(Net_451),
        .tx_interrupt(Net_452),
        .rx_interrupt(Net_453),
        .tx_data(Net_454),
        .tx_clk(Net_455),
        .rx_data(Net_456),
        .rx_clk(Net_457));
